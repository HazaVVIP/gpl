#!/usr/bin/env python3
"""
gpl — GraphQL Data Dump Tool  (async edition)
Usage: gpl --url <endpoint> [OPTIONS]
...
import argparse, asyncio, json, logging, os, re, ssl, sys, time
...
def _gql_raw(url: str, query: str, token: Optional[str] = None,
    ...
    headers = {
        ...
        "User-Agent":     "Mozilla/5.0 (GPL-Tool/4.0)",
